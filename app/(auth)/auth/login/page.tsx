...
export default function Login() {
  ...
  return (
    <div className="flex h-full w-full items-stretch text-gray-600">
      ...
      <div className="w-7/12 px-20 py-8">
        <div className="flex h-full w-full flex-col justify-between space-y-8">
          <div className="flex items-center justify-end space-x-4">
            ...
            <a
              href="#"
              className="block rounded border px-4 py-2 font-semibold hover:bg-gray-100"
            >
              Sign Up
            </a>
          </div>
          ...
          <div>
            ...
            <h5 className="mt-4 text-4xl font-semibold text-gray-800">
              Welcome Back
            </h5>
